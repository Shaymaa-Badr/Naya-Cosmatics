...
الطبيعية، و اصباغ الشعر من جميع الالوان المميزة مع جودة عالية.`,
        ...
        mission_p2: `علاوة على ذلك، نقدم زبائنك (المستخدمين النهائيين) رعاية استثنائية تدوم مدى الحياة
        من خلال تزويدهم بجودة عالية من منتجات العناية و خدمة عملاء المميزة.`,
